...
//-------------------------
int TFile::CloseFile(void* _pFile)
{
...
//-------------------------
unsigned int TFile::ReadFile(void* _pFile, char* pBuffer_, unsigned int _uBufferSize)
{
	assert(_pFile != nullptr);
...
//-------------------------
unsigned int TFile::WriteFile(void* _pFile, const char* _pBuffer, unsigned int _uBufferSize)
{
	assert(_pFile != nullptr);
