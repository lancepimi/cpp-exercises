...
//-------------------------
void* MyNamespace::OpenFile(const char* _sFileName, const char* _sMode)
{
...
//-------------------------
int MyNamespace::CloseFile(void* _pFile)
{
...
//-------------------------
unsigned int MyNamespace::ReadFile(void* _pFile, char* pBuffer_, unsigned int _uBufferSize)
{
	assert(_pFile != nullptr);
...
//-------------------------
unsigned int MyNamespace::WriteFile(void* _pFile, const char* _pBuffer, unsigned int _uBufferSize)
{
	assert(_pFile != nullptr);
